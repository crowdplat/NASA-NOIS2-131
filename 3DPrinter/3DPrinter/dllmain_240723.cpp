...
ProError executeInterdigitatedCapacitorPbAction(char* dialog, char* component, ProAppData appdata)
{
	...
	status = placeInterdigitatedCapacitorPbAction(paramsDialogLCR, okbtn, (ProAppData)bondpadUdfpath);
...
ProError executeResistorNetwork1Action(char* dialog, char* component, ProAppData appdata)
{
	...
	char bondpadUdfpath[PRO_PATH_SIZE] = "";
	strcpy(bondpadUdfpath, cTextDirPath);
	strcat(bondpadUdfpath, "\\text\\UDF_LATEST\\resistor_network_udf.gph");
	...
	status = placeResistorNetwork1PbAction(paramsDialogLCR, okbtn, (ProAppData)bondpadUdfpath);
...

{
	...
	char bondpadUdfpath[PRO_PATH_SIZE] = "";
	strcpy(bondpadUdfpath, cTextDirPath);
	strcat(bondpadUdfpath, "\\text\\UDF_LATEST\\resistor_network2_udf.gph");
	...
	status = placeResistorNetwork2PbAction(paramsDialogLCR, okbtn, (ProAppData)bondpadUdfpath);
